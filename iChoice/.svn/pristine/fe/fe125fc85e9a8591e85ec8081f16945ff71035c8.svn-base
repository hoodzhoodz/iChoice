...
public class DayFragment extends BaseFragment {
    ...
    private TemperatureOperation temperatureOperation;
    private int unit;
    ...
    private void initTempChart() {
        ...
        temp_chart.setVisibleXRange(0, 24);
    ...
    private void CalendarMoveChart(Calendar endCalendar) {
        ...
        temp_chart.moveViewToX(diff * 24f);
    ...
    public boolean isBegin(Calendar calendar) {
        int Year = calendar.get(Calendar.YEAR);
        int Month = calendar.get(Calendar.MONTH);
        int Day = calendar.get(Calendar.DATE);
        int nYear = beginCalendar.get(Calendar.YEAR);
        int nMonth = beginCalendar.get(Calendar.MONTH);
        int nDay = beginCalendar.get(Calendar.DAY_OF_MONTH);
    ...
    private void setChartData() {
        ...
        List<Cbp1k1Data> cbp1k1DataList = cbp1k1Operation.queryAVGDataByThreeHour(IchoiceApplication.getAppData().userProfileInfo.getUserId());
