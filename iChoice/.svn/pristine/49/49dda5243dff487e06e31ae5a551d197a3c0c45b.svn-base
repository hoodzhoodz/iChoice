...
import com.choicemmed.cbp1k1sdkblelibrary.cmd.command.BP2941BindCommand;
 ...
 * @version V1.0.0
 */
public class BP2941BindCommandFactory implements BP2941CreateCommandListener{
    @Override
    public BP2941BaseCommand createCommand(BP2941Ble ble) {
        return new BP2941BindCommand(ble);
    }
}
