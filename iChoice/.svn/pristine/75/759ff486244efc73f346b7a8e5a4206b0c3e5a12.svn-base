...
public class OXSpotHistoricalResultsFragment extends BaseFragment {
    ...
    private void refreshdata(Calendar c) {
        ...
        List<OxSpotData> listAll = oxSpotOperation.queryBySyncState(IchoiceApplication.getAppData().userProfileInfo.getUserId());
        if (!listAll.isEmpty()) {
        ...
        oxSpotDataList = oxSpotOperation.queryByDate(dateTimeString, IchoiceApplication.getAppData().userProfileInfo.getUserId());
