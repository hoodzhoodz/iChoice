...
public class TemperatureHistoricalTrendFragment extends BaseFragment {
    ...
    protected void initialize() {
        fragments.add(new TemperatureDayFragment());
        fragments.add(new TemperatureWeekFragment());
        fragments.add(new TemperatureMonthFragment());
        fragments.add(new TemperatureYearFragment());
