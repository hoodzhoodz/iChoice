...
public class TemperatureMonthFragment extends BaseFragment {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.calendar_left:
                if (calendar.before(beginCalendar) || isMonth(calendar, beginCalendar)) {
                    return;
                }
    ...
    private void initChart() {
        ...
        temperature_chart.setVisibleXRange(0, 31);
        ...
        if (cft308DataHashMapC.size() > 0) {
            ...
            for (int i = 0; i < calendar1.getActualMaximum(Calendar.DAY_OF_MONTH); i++) {
                ...
                if (cft308Data != null) {
                    ...
                    times.setText(calendar1.get(Calendar.DAY_OF_MONTH) + "" + getString(R.string.day));
