...
private UpLoadDialogFragment dialogFragment;
    ...
    private BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (intent.getAction().equals("W628BleConService:syncSuccess")) {
                upLoadSuccess = true;
            } else if (intent.getAction().equals("resetState")) {
    ...
    private void refreshData() {
        ...
        w628Data = w628Operation.queryByNow(IchoiceApplication.getAppData().userProfileInfo.getUserId());
        if (w628Data == null){
            return;
        }
