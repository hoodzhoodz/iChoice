...
public interface W628Listener {
     ...
     * @param recordTime
     */
    void onRecordDataResponse(String recordData, String recordTime, long timeDiff);
    ...
    /**
     * 返回实时PI数据
     * @param realTimePIDate
     */
    void onRealTimePIData(float realTimePIDate);

    /**
     * 返回实时呼吸数据
     * @param realTimeRRDate
     */
    void onRealTimeRRData(int realTimeRRDate);
