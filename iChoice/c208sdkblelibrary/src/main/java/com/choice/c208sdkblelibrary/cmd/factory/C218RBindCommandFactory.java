...
import com.choice.c208sdkblelibrary.cmd.command.C218RBindCommand;

public class C218RBindCommandFactory implements C218RCreatCommandListener {
    @Override
    public C218RBaseCommand createCommand(C218RBle ble, String reportNumberOfStoredRecordsCmd) {
        return new C218RBindCommand(ble);
    }
