...
/**
 * Created by Yu Baoxiang on 2015/5/19.
 */
public class EcgView extends View {
        ...
        for (int i = 0; i < attributes.getIndexCount(); i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.EcgSettings_bigCellCount:
                    int ecgBigCellCount = attributes.getInt(attr, mDefaultHeight / 50);
                ...
                case R.styleable.EcgSettings_scaleW:
                    if ("A12".equals(IchoiceApplication.type)) {
                        ...
                        mP10bScaleW = attributes.getFloat(attr, mScaleW);
                    }
                    break;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if ("A12".equals(IchoiceApplication.type)) {
            ...
            width = height * mP10bDefaultWidth / mDefaultHeight;
        }
    ...
    private void drawEcgData(Canvas canvas, int[] ecgData) {
        try {
            ...
            for (int i = 0; i < ecgData.length; i++) {
                ...
                float y = ecgPoint2ScreenPointY(ecgPoint);
                if (i == 0) {
                    if ("A12".equals(IchoiceApplication.type)) {
